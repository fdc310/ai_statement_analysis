...
class HunyuanService(TencentCloudClient):
    ...
    async def chat_multimodal(
        ...
        """
        timeout = timeout or self.timeout
        use_model = model or (settings.openai_multimodal_model if self.backend == "openai" else settings.hunyuan_multimodal_model)
    ...
    async def generate_evaluation(
        ...
        """Generate speech evaluation report in JSON format (async)."""
